    ...
    <div class="mt-4">
        ...
        <form action="{{ route('vendors.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="vendor_nama" class="form-control" id="vendor_nama" placeholder="Masukkan nama vendor" value="{{ old('vendor_nama') }}" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="lokasi" class="form-control" id="lokasi" placeholder="Masukkan lokasi vendor" value="{{ old('lokasi') }}" required>
            </div>
